...
# WARNING: it's required to use iCloud
...
# Desktop + Normal
# I do not recall why I use -literalpath here but I do of wasting a sensible amount of time to make this work so I'll keep it as is
...
CreateRegIfNotExists -Path "HKCU:\Software" -Name "Sysinternals"
CreateRegIfNotExists -Path "HKCU:\Software\Sysinternals" -Name "Process Explorer"
Set-ItemProperty -LiteralPath 'HKCU:\Software\Sysinternals\Process Explorer' -Name "key_shift" -Value "false"
Set-ItemProperty -LiteralPath 'HKCU:\Software\Sysinternals\Process Explorer' -Name "HideWhenMinimized" -Value "1"
Set-ItemProperty -LiteralPath 'HKCU:\Software\Sysinternals\Process Explorer' -Name "TrayCPUHistory" -Value "1"
Set-ItemProperty -LiteralPath 'HKCU:\Software\Sysinternals\Process Explorer' -Name "ShowPhysTray" -Value "1"
