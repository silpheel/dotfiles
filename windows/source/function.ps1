...
$colorRegularHighlight = getColor("REGULAR_HIGHLIGHT")
$colorFeedback = getColor("FEEDBACK")
$colorFeedbackHighlight = getColor("FEEDBACK_HIGHLIGHT")
$colorError = getColor("ERROR")
$colorErrorHighlight = getColor("ERROR_HIGHLIGHT")
